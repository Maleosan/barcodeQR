const CACHE='stokqr-v1';
const ASSETS=['/','/styles.css','/src/app.js','/src/database.js','/src/inventory-service.js','/src/scanner.js','/src/qr.js','/manifest.webmanifest','/icons/icon.svg'];
